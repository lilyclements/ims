...
The answer to this question relies on the idea that statistical data analysis is somewhat of an art.
...
We look in the second row corresponding to the family income variable.
...
::: {.guidedpractice data-latex=""}
Should we have concerns about applying least squares regression to the Elmhurst data in @fig-elmhurstScatterW2Lines?

::: {.callout-note collapse="true"}
## Solution

The trend appears to be linear, the data fall around the line with no obvious outliers, the variance is roughly constant.
