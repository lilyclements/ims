...
What does 0.802 represent in @tbl-loan-home-app-type-column-proportions?
...
What does 0.135 represent in @tbl-loan-home-app-type-column-proportions?
...
::: {.guidedpractice data-latex=""}
What components of each plot in @fig-countyIncomeSplitByPopGain do you find most useful?
...
::: {.guidedpractice data-latex=""}
What components of the ridge plot in @fig-countyIncomeSplitByPopGainRidge do you find most useful compared to those in @fig-countyIncomeSplitByPopGain?

::: {.callout-note collapse="true"}
## Solution

The ridge plot give us a better sense of the shape, and especially modality, of the data.
:::
:::
...
::: {.guidedpractice data-latex=""}
Based on @fig-countyIncomeRidgeMulti, what can you say about how median household income in counties vary depending on population gain/no gain, metropolitan area/not, and median degree?

::: {.callout-note collapse="true"}
## Solution

Regardless of the location (metropolitan or not) or change in population, it seems like there is an increase in median household income from individuals with only a HS diploma, to individuals with some college, to individuals with a Bachelor's degree.
:::
:::
